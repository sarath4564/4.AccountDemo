...
namespace EventsEx01 
{
    ...
    public class TransactionEventArgs : EventArgs
    {
        ...
        public object amont { get; internal set; }
...
class Program
    {
        static void Main()
        {
            ...
            acnt1.TransactionMade += TransactionHolder;
            acnt2.TransactionMade += TransactionHolder;
            acnt1.Debit(2000);
            acnt2.Credit(4000);
          }
        static void TransactionHolder(object sender,TransactionEventArgs e)
        {
            Console.WriteLine($"{e.amont} {e.TransactionType}");
        }
    }
}
